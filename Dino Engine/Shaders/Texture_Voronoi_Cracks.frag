...
uniform bool warpSmudge;
uniform float smudgePhase;
uniform int returnMode;

void main(void)
{   
    vec3 value = cracks(textureCoords, scale, jitter, width, smoothness, warp, warpScale, warpSmudge, smudgePhase, seed);

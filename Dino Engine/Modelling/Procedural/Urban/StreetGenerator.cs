    ...
    public class StreetGenerator
    {
        ...
        public Mesh GenerateCrossRoad()
        {
            ...
            for (int sideIndex = 0; sideIndex<4; sideIndex++)
            {
                ...
                trafficLight.rotate(new Vector3(-MathF.PI*0.5f, 0f, 0f));
                trafficLight.translate(new Vector3(TotalWidth * 0.5f-sideWalkWidth+1, TotalWidth * 0.5f - sideWalkWidth+1, -sideWalkHeight * 0.5f));
                side += trafficLight;
        ...
        public Mesh GenerateTrafficLight()
        {
            ...
            Material blackMaterial = new Material(new Colour(20, 20, 20, 1.0f), 0.0f, 0.8f, 0.0f);
            Material redMaterial = new Material(new Colour(235, 15, 15, 1.0f), 0.0f, 0.2f, 20.0f);
            Material greenMaterial = new Material(new Colour(15, 235, 15, 1.0f), 0.0f, 0.2f, 0.3f);
            Material yellowMaterial = new Material(new Colour(235, 235, 15, 1.0f), 0.0f, 0.2f, 0.3f);

...
namespace Dino_Engine.ECS
{
    public class ECSEngine
    {
        ...
        private EntityOLD _camera = null;
        public EntityOLD Camera { get => _camera; }
        public List<EntityOLD> Entities { get => getSystem<AllEntitySystem>().MemberEntities;}
        ...
        public void InitEntities()
        {
            ...
            EntityOLD sun = new EntityOLD("Sun");
            sun.addComponent(new ColourComponent(new Colour(1.0f, 1.0f, 1.0f, 35.0f)));
            sun.addComponent(new DirectionComponent(new Vector3(-1f, 1.5f, 3.9f)));
            ...
            EntityOLD sky = new EntityOLD("Sky");
            ...
            sky.addComponent(new DirectionComponent(new Vector3(0.0f, 1f, 0.0f)));
        ...
        public bool AddEnityToSystem<T>(EntityOLD entity) where T : ComponentSystem
        {
        ...
        public void HandleInput()
        {
            ...
            {
                foreach (EntityOLD entity in Entities)
                {
        ...
        public void ClearAllEntitiesExcept(params EntityOLD[] exceptions)
        {
            var entities = Entities;
            for (int i = entities.Count - 1; i >= 0; i--)
            {
                EntityOLD entity = entities[i];
